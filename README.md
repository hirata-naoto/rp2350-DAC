...
- 2ch PCM
- 16-bit / 24-bit
- 16-bit: 44.1 / 48 / 88.2 / 96 / 176.4 / 192 kHz
- 24-bit: 44.1 / 48 / 88.2 / 96 kHz

24-bit ストリームは 96 kHz まで、16-bit ストリームは 192 kHz まで受け付けます。I2S 出力は互換性を優先して常に 32-bit スロットで送出し、16-bit/24-bit PCM は左詰めで配置します。LRCLKの仕様はI2Sです。
